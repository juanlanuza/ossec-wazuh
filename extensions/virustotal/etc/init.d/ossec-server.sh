...
# Add for the execution of the ext_virus_total.py
...
# path to python bin
DAEMON_PYTHON=${PYTHON_BIN-/usr/bin/python2.7}
...
## --END OF DAEMON FOR ext_virus_total
...
enable()
{
    #enables the ext_virus_total
    start-stop-daemon -d $APP_PATH -c $RUN_AS --group=${RUN_GROUP} $EXTRA_SSD_OPTS --start --quiet --pidfile $PID_FILE --exec $DAEMON_PYTHON -- $DAEMON_OPTS
